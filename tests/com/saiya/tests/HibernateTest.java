...
public class HibernateTest {
    ...
    public void doTest() {
        ...
        //实测数据存放地点
        File files = new File("/Users/SaiYa/Documents/Code/Graduate/文档/数据/实测数据/");
        //读取输入数据到内存
        for (File file :files.listFiles()) {
            ...
            //计算输出数据并输出
            File dis = new File("/Users/SaiYa/Documents/Code/Graduate/文档/数据/分析后数据/" +
                    file.getName() + "-误差对比.csv");
            File eud = new File("/Users/SaiYa/Documents/Code/Graduate/文档/数据/分析后数据/" +
                    file.getName() + "-欧氏距离.csv");
